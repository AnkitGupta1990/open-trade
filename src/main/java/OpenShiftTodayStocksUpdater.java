...
public class OpenShiftTodayStocksUpdater extends HttpServlet {
	...
	public static void updateOpenShiftTodayStocks() throws Exception {
		...
		String[] command = new String[]{"curl", "http://auto-trade-auto-trade.apps.us-east-1.online-starter.openshift.com/UpdateTodayStocks?today_stocks="+URLEncoder.encode(replacement.replace("'", ""), "UTF-8" )};
